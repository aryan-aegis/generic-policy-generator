// PDF errors
const UNABLE_TO_DOWNLOAD_FILE = 'Unable to download file. Please download PDF manually and upload.';
const SEND_PDF_TO_SERVER_FAILED = 'Sending PDF to server failed. Please download PDF manually and upload.';
...
const INSURER_DOES_NOT_SUPPORT_POLICY_TYPE = 'Invalid request. Insurer does not support this policy type.';
...
const UNABLE_TO_UPDATE_CLICKUP_TASK_STATUS = 'Unable to update task status in ClickUp';
const UNABLE_TO_ADD_CLICKUP_COMMENT = 'Unable to add comment to task in ClickUp';
